...
USERNAME = environ.get('USERNAME', "https://t.me/Itsme123i") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002288135729'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/Tamil_movez_grp')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/all_in_1grp') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
